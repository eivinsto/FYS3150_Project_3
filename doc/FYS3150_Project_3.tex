...
The total energy was also measured, and the standard deviation of the total energy from the mean in these simulations can be seen in table \ref{table:se-3c-energydeviation}. We can see that the calculated energy is generally not as stable with the forward Euler
