...
\begin{document}
\title{On the simulation of gravitational interaction in an n-body system using the forward Euler and Velocity-Verlet methods of numerical integration}   % self-explanatory
