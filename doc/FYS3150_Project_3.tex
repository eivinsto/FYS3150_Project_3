...
With the Jupiter mass at \(1000\)x its normal mass, we can se that the Sun's orbit around the center of mass is significant with an apoapsis of more than \(2\) AU, since Jupiter effectively functions as second star. 
