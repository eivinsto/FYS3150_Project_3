...
\caption{This figure contains a 2D plot of the simulated orbit of the Sun around the center of mass (origin of the plane), for the Sun-Earth-Jupiter system with. The simulation was ran with $N=10^7$ timesteps and steplength $\Delta t = \num{1.2e-06}$ years.}
